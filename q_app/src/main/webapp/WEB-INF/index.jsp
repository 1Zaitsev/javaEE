                ...
                <c:forEach var="prod" items="${requestScope.products}">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:url value="/add" var="addToCart">
                                <c:param name="id" value="${prod.id}"/>
                            </c:url>

                            <a class="btn btn-success" href=""><i class="fas fa-shopping-cart"></i></a>
                            <a class="btn btn-primary" href="${productEditUrl}"><i class="fas fa-edit"></i></a>
